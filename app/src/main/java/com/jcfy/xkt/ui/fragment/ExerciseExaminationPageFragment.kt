 ...
 * @author linzheng
 */
class ExerciseExaminationPageFragment : BaseListFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mAdapter.register(ExerciseExaminationMenu::class, ExerciseItemViewBinder())
    ...
    companion object {
        fun newInstance(items:ArrayList<ExerciseExaminationMenu>): ExerciseExaminationPageFragment {
            val args = Bundle()
            args.putParcelableArrayList("items",items)
            val fragment = ExerciseExaminationPageFragment()
