 ...
 * @author linzheng
 */
class ExerciseItemViewBinder : ItemViewBinder<ExerciseExaminationMenu, ExerciseItemViewBinder.ExerciseViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ExerciseViewHolder, item: ExerciseExaminationMenu) {
